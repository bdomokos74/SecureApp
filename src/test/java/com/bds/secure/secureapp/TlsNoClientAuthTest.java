...
@ActiveProfiles("ssl-test-no-clientauth")
public class TlsNoClientAuthTest extends TlsBaseTest {
    ...
    @Test
    void clientAcceptSelfSignedServerCertServerAcceptsDefaultClientCert() throws Exception {
    ...
    @Test
    void clientAcceptSelfSignedServerCertServerRejectsThirdClientCert() throws Exception {
    ...
    @Test
    void serverAcceptsThirdClientCert() throws Exception {
